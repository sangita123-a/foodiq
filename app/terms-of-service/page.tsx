  ...
  return (
    <main className="min-h-screen bg-background pt-[90px]">
      ...
      <div className="container mx-auto px-4 md:px-8 py-12 max-w-3xl">
        <h1 className="text-3xl md:text-4xl font-black text-foreground mb-6">Terms of Service</h1>
        ...
        <div className="prose space-y-4 text-[#555555] mt-6">
          ...
          <h2 className="text-xl font-bold text-foreground mt-8">Orders & Payments</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-foreground mt-8">Cancellations</h2>
          <p>
