...
export default function PopularCuisinesPage() {
  return (
    <main className="relative min-h-screen bg-background pt-[90px] selection:bg-primary/15 selection:text-foreground">
      <Navbar />
      <FloatingCart />
      <header className="mx-auto w-[calc(100%_-_32px)] max-w-[1600px] pb-8 pt-12 md:w-[calc(100%_-_48px)] md:pb-10 md:pt-16">
        <div className="max-w-3xl">
          ...
          <h1 className="text-3xl font-black tracking-[-0.04em] text-foreground md:text-5xl">
            All Cuisines
          </h1>
          <p className="mt-3 text-base leading-7 text-gray-text md:text-lg">
