        ...
        <div className="bg-[#171717] rounded-3xl p-6 md:p-8 border border-white/5">
          <div className="flex flex-col md:flex-row gap-6 mb-8">
            ...
            <div className="flex-1">
              ...
              <span className="inline-flex text-xs font-bold px-3 py-1 rounded-full border border-white/20 text-white">
                {status}
              </span>
            </div>
          ...
          <div className="flex items-center gap-2 text-sm text-gray-400 mb-8 pb-8 border-b border-white/10">
          ...
          <div className="bg-[#111] rounded-2xl p-6 border border-white/5 space-y-3 text-sm mb-8">
            <div className="flex justify-between text-gray-400">
              <span>Subtotal</span>
              <span className="text-white">₹{order.subtotal ? parseFloat(order.subtotal).toFixed(0) : 0}</span>
            </div>
            <div className="flex justify-between text-gray-400">
          ...
          {isTrackable && (
            <Link href={`/track-order?id=${order.id}`}>
              <button className="w-full bg-blue-500 hover:bg-blue-600 text-white py-3 rounded-xl font-bold flex items-center justify-center gap-2">
