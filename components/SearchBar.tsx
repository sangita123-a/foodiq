  ...
  return (
    <div ref={wrapRef} className="relative w-full max-w-[900px]">
      ...
      >
        ...
        <button
          type="submit"
          className="h-[44px] sm:h-[50px] md:h-[56px] w-[72px] sm:w-[92px] md:w-[170px] bg-[var(--color-primary)] hover:bg-[var(--color-primary-hover)] text-white font-semibold text-xs sm:text-sm rounded-xl transition-all active:translate-y-0 shadow-[0_7px_18px_rgba(226,55,68,0.28)] shrink-0 mr-1 touch-target"
        >
