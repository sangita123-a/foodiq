  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      <a
        ...
        className="flex items-center gap-4 bg-white rounded-2xl border border-[#E5E7EB] p-5 hover:border-[#E23744] transition"
      >
        <div className="w-12 h-12 rounded-xl bg-[#E23744]/10 flex items-center justify-center">
          <Mail className="w-6 h-6 text-[#E23744]" />
        </div>
        <div>
          <p className="text-xs font-bold uppercase text-[#9CA3AF]">Email</p>
          <p className="font-bold text-sm text-[#111827]">{contact.email}</p>
        </div>
      </a>
      <a
      ...
      >
        ...
        <div>
          ...
          <p className="font-bold text-sm text-[#111827]">{contact.phone}</p>
        </div>
      </a>
      <a
        href={`https://wa.me/${wa}`}
      ...
      >
        ...
        <div>
          ...
          <p className="font-bold text-sm text-[#111827]">{contact.whatsapp}</p>
        </div>
      </a>
    </div>
  );
