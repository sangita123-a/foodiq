...
export default function CompactSearchBar() {
  ...
  return (
    <form onSubmit={handleSearch} className="w-full max-w-[850px] h-[65px] bg-white border border-[var(--color-border)] rounded-[20px] flex items-center shadow-xl overflow-hidden relative mx-auto">
      ...
      <button 
        type="submit"
        className="touch-target h-[52px] w-[140px] bg-[var(--color-primary)] hover:bg-[var(--color-primary-hover)] text-white font-bold rounded-[14px] transition-all hover:scale-105 active:scale-95 shadow-[0_4px_12px_rgba(0,0,0,0.08)] shrink-0 mr-1.5"
      >
        Search
      </button>
    </form>
