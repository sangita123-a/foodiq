  ...
  return (
    <div className="relative w-full">
      ...
      <div className="container mx-auto px-4 md:px-8 relative -mt-32 md:-mt-40 z-10">
        <div className="bg-[#121212] border border-white/10 rounded-[24px] p-6 md:p-8 shadow-2xl backdrop-blur-sm flex flex-col md:flex-row gap-6 md:items-center">
          
          {/* Logo */}
          <div className="w-24 h-24 md:w-32 md:h-32 rounded-2xl overflow-hidden border-4 border-[#121212] shadow-xl flex-shrink-0 bg-white">
            <SafeImage
              src={restaurant.logo}
              fallback={RESTAURANT_FALLBACK}
          ...
          <div className="flex-1">
            <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-3">
              <div>
                <div className="flex items-center gap-3 mb-2">
                  <h1 className="text-3xl md:text-4xl font-bold text-white tracking-tight">{restaurant.name}</h1>
                  {restaurant.isOpen && (
              ...
              <div className="flex items-center gap-3">
                <button className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-white/10 hover:text-[#FF2D3B] transition-all group">
                  <Heart className="w-5 h-5 group-hover:fill-[#FF2D3B] transition-all" />
                </button>
            ...
            {/* Stats Row */}
            <div className="flex flex-wrap items-center gap-4 md:gap-8 mt-6 pt-6 border-t border-white/10">
              <div className="flex items-center gap-2">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-gray-500 text-xs">{restaurant.reviewsCount} Reviews</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-gray-500 text-xs">Cost for two</span>
                </div>
              </div>
