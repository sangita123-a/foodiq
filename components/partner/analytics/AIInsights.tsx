...
export default function AIInsights({ insights }: AIInsightsProps) {
  ...
  const getIcon = (text: string) => {
    ...
    return <Utensils className="w-5 h-5 text-[#E23744]" />;
  };

  return (
    <div className="bg-gradient-to-br from-[#FFFFFF] to-[#E23744]/5 rounded-3xl p-6 md:p-8 border border-[#E23744]/20 shadow-[0_0_30px_rgba(226, 55, 68,0.05)] mb-8">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-[#E23744] text-xs font-bold uppercase tracking-wider">Generated from your real-time data</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {insights.map((insight, idx) => (
          <motion.div 
            ...
            className="bg-[#F8FAFC] border border-[#E5E7EB] rounded-2xl p-5 hover:border-[#E23744]/30 transition-colors group"
          >
