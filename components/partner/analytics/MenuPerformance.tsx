    ...
    >
      ...
      <div className="absolute inset-0 p-5 flex flex-col justify-between">
        <div className="flex items-start justify-between">
          <span className="bg-black/50 backdrop-blur-md text-white text-[10px] font-black uppercase tracking-wider px-3 py-1.5 rounded-full border border-white/20 flex items-center gap-1.5">
        ...
        <div>
          ...
          <p className="text-gray-300 text-sm font-bold bg-black/30 w-max px-2 py-1 rounded backdrop-blur-sm border border-white/10 group-hover:-translate-y-1 transition-transform delay-75">
            <span className="text-[10px] uppercase tracking-wider text-gray-400 mr-1">{item.metricLabel}:</span> 
