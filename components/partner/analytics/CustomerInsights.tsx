      ...
      <div className="flex flex-col md:flex-row items-center gap-8 mb-8 flex-1">
        ...
        <div className="relative w-40 h-40 shrink-0 group">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <span className="text-2xl font-black text-foreground">{data.returningPercentage}%</span>
            <span className="text-[10px] text-gray-text font-bold uppercase tracking-wider">Returning</span>
          </div>
        </div>

        <div className="flex-1 space-y-4 w-full">
          <div className="flex items-center justify-between p-3 rounded-xl bg-section border border-border">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-bold text-gray-text">New</span>
            </div>
            <span className="text-foreground font-black">{data.newPercentage}%</span>
          </div>
          ...
          <div className="flex items-center justify-between p-3 rounded-xl bg-section border border-border">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-bold text-gray-text">Returning</span>
            </div>
            <span className="text-foreground font-black">{data.returningPercentage}%</span>
          </div>
        </div>
      ...
      <div className="space-y-5">
        <div>
          <div className="flex justify-between text-sm mb-2">
            <span className="text-gray-text font-bold flex items-center gap-1"><Heart className="w-3.5 h-3.5 text-red-500"/> Satisfaction Rate</span>
            <span className="text-foreground font-black">{data.satisfaction}%</span>
          </div>
          <div className="w-full h-2 bg-section rounded-full overflow-hidden border border-border">
            <motion.div 
              initial={{ width: 0 }}
              animate={{ width: `${data.satisfaction}%` }}
              transition={{ duration: 1, delay: 0.2 }}
              className="h-full bg-gradient-to-r from-red-600 to-primary-hover rounded-full"
            />
          </div>
        </div>
        ...
        <div>
          <div className="flex justify-between text-sm mb-2">
            <span className="text-gray-text font-bold flex items-center gap-1"><UserCheck className="w-3.5 h-3.5 text-blue-500"/> Repeat Order %</span>
            <span className="text-foreground font-black">{data.repeatPercentage}%</span>
          </div>
          <div className="w-full h-2 bg-section rounded-full overflow-hidden border border-border">
            <motion.div 
              initial={{ width: 0 }}
