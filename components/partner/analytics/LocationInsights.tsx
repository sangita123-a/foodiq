    ...
    <div className="bg-background rounded-3xl p-6 md:p-8 border border-border shadow-xl flex flex-col h-full">
      <div className="flex items-center justify-between mb-8">
        <h3 className="text-xl font-black text-foreground flex items-center gap-2">
          <MapPin className="w-6 h-6 text-primary" /> Location Insights
        </h3>
      </div>
      ...
      <div className="flex flex-col xl:flex-row gap-8 flex-1">
        ...
        {/* Heatmap Placeholder */}
        <div className="flex-1 min-h-[200px] bg-section rounded-2xl border border-border relative overflow-hidden group">
          ...
          <motion.div 
            ...
            className="absolute bottom-1/4 right-1/3 w-32 h-32 bg-primary/40 blur-xl rounded-full"
          />
          <motion.div 
        ...
        <div className="w-full xl:w-64 flex flex-col justify-center space-y-4">
          <h4 className="text-sm font-bold text-gray-text uppercase tracking-wider mb-2">Top Delivery Areas</h4>
          {data.map((loc, idx) => (
            <motion.div 
              key={loc.area}
            ...
            >
              <div className="flex justify-between text-sm mb-1">
                <span className="text-foreground font-bold">{loc.area}</span>
                <span className="text-gray-text font-bold">{loc.percentage}%</span>
              </div>
