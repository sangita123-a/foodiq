      ...
      {stats.map((stat, idx) => (
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <h3 className="text-2xl xl:text-3xl font-black text-white mb-1">
              <Counter from={0} to={stat.value} prefix={stat.prefix} />
            </h3>
            <p className="text-gray-400 text-xs font-bold uppercase tracking-wider line-clamp-1">{stat.title}</p>
          </div>
        </motion.div>
      ))}
    </div>
