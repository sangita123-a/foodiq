...
export default function OffersEmptyState({ onCreateNew }: OffersEmptyStateProps) {
  return (
    ...
    >
      ...
      <h3 className="text-2xl font-black text-foreground mb-3">No promotional offers found.</h3>
      ...
      <button 
        onClick={onCreateNew}
        className="px-6 py-3 bg-primary hover:bg-primary-hover text-white rounded-xl font-bold flex items-center gap-2 transition-colors shadow-lg shadow-primary/20"
      >
