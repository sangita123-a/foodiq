    ...
    <div className="bg-[#171717] rounded-3xl p-6 md:p-8 border border-white/5 shadow-xl h-full">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <span className="bg-red-500/20 text-primary text-xs font-bold px-2 py-1 rounded-md animate-pulse">3 New</span>
        </div>
      ...
      <div className="space-y-4">
        {orders.map((order, idx) => (
          <motion.div 
            ...
            className="bg-[#111] rounded-2xl p-5 border border-white/5 hover:border-white/10 transition-colors group"
          >
            <div className="flex flex-col sm:flex-row justify-between gap-4">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="text-xs text-gray-500 flex items-center gap-1"><Clock className="w-3 h-3" /> {order.time}</span>
                </div>
                <h4 className="text-white font-bold text-lg mb-1">{order.customer}</h4>
                <p className="text-gray-400 text-sm">{order.items}</p>
                <div className="mt-3 font-bold text-white">{order.amount}</div>
              </div>
              ...
              <div className="flex flex-col gap-2 justify-center sm:w-32">
                ...
                <button className="w-full bg-white/5 hover:bg-white/10 text-white border border-white/10 py-2 rounded-lg text-sm font-bold transition-colors flex items-center justify-center gap-1">
