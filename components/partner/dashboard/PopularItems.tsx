  ...
  return (
    <div className="bg-background rounded-3xl p-6 md:p-8 border border-border shadow-xl h-full">
      ...
      <div className="space-y-4">
        {display.length === 0 && (
          <p className="text-gray-text text-sm py-6 text-center">No sales data yet.</p>
        )}
        {display.map((item, idx) => (
          <div key={idx} className="flex items-center gap-4 bg-section p-3 rounded-2xl border border-border group hover:border-border transition-colors cursor-pointer">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-gray-text text-xs mt-1">{item.orders} Orders</p>
            </div>
