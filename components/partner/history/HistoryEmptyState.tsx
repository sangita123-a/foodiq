...
export default function HistoryEmptyState() {
  return (
    ...
    >
      ...
      <h3 className="text-2xl font-black text-white mb-3">No previous orders found.</h3>
      ...
      <Link 
        href="/partner/orders"
        className="px-6 py-3 bg-primary hover:bg-[#e02633] text-white rounded-xl font-bold flex items-center gap-2 transition-colors shadow-lg shadow-primary/20 group"
      >
