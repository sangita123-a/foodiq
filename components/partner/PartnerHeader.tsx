      ...
      <div className="h-16 sm:h-20 bg-[#FFFFFF] border-b border-[#E5E7EB] flex items-center justify-between px-3 sm:px-4 lg:px-8 sticky top-0 z-30 safe-top">
        <div className="flex items-center gap-3 min-w-0">
          <button
            ...
            className="lg:hidden touch-target flex items-center justify-center text-[#6B7280] hover:text-[#111827] transition-colors p-2 -ml-1"
          ...
          <div className="flex items-center gap-2 sm:gap-3 min-w-0">
            <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-white flex items-center justify-center overflow-hidden border-2 border-[#E5E7EB] shrink-0">
              <SafeImage
                src={logo}
            ...
            <div className="min-w-0">
              <h2 className="text-[#111827] font-black leading-none text-sm sm:text-base truncate">{name}</h2>
        ...
        <div className="flex items-center gap-2 sm:gap-4 shrink-0">
          <div className="flex items-center gap-2 sm:gap-3 bg-[#F8FAFC] px-2 sm:px-4 py-1.5 sm:py-2 rounded-full border border-[#E5E7EB]">
            <span
          ...
          <Link
            ...
            className="touch-target w-10 h-10 rounded-full bg-[#F8FAFC] border border-[#E5E7EB] flex items-center justify-center text-[#6B7280] hover:text-[#111827] shrink-0"
          >
