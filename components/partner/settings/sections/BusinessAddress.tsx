  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-400 text-sm mb-6">Set your restaurant's physical location for delivery and pickup.</p>
      </div>
      ...
      <div className="mt-8">
        <label className="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Pin Location on Map</label>
        
        <div className="w-full h-64 bg-[#111] border border-white/10 rounded-3xl relative overflow-hidden group">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            ...
            >
              <MapPin className="w-10 h-10 text-primary drop-shadow-[0_10px_10px_rgba(224,38,51,0.5)]" />
            </motion.div>
          </div>
          ...
          <div className="absolute inset-0 bg-black/60 backdrop-blur-[2px] opacity-0 group-hover:opacity-100 transition-opacity flex flex-col items-center justify-center">
            <button className="px-6 py-3 bg-white text-black rounded-xl font-bold text-sm hover:bg-gray-200 transition-colors shadow-lg">
              Open Google Maps Integration
            </button>
            <p className="text-gray-400 text-xs mt-3">API configuration required.</p>
          </div>
        </div>
      </div>
    </div>
