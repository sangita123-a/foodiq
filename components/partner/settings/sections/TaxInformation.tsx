    ...
    <div className="space-y-8">
      <div>
        <h2 className="text-2xl font-black text-[#111827] flex items-center gap-2 mb-2">
          <FileText className="w-6 h-6 text-[#E23744]" /> Tax Information
        </h2>
        <p className="text-[#6B7280] text-sm mb-6">Manage your business registration and taxation details for legal compliance.</p>
      </div>

      <div className="bg-[#E23744]/10 border border-[#E23744]/20 rounded-2xl p-4 flex items-start gap-4">
        <ShieldAlert className="w-6 h-6 text-[#E23744] shrink-0 mt-0.5" />
        <div>
          <h4 className="text-[#E23744] font-bold mb-1">Legal Compliance Required</h4>
