...
const menuItems: MenuItem[] = [
  ...
  { name: "Live Deliveries", icon: Bike, href: "/admin/live-deliveries", permission: "live" },
  ...
  { name: "Delivery Zones", icon: MapPin, href: "/admin/delivery-zones", permission: "delivery" },
  { name: "Delivery KYC", icon: ShieldCheck, href: "/admin/delivery-documents", permission: "delivery" },
  { name: "Withdrawals", icon: Wallet, href: "/admin/withdrawals", permission: "delivery" },
  { name: "Delivery Bank Accounts", icon: Landmark, href: "/admin/delivery-bank-accounts", permission: "delivery" },
  { name: "Delivery Notifications", icon: Bell, href: "/admin/delivery/notifications", permission: "notifications" },
  { name: "Delivery Support", icon: Headphones, href: "/admin/delivery-support", permission: "delivery" },
  { name: "Delivery Reviews", icon: Star, href: "/admin/delivery-reviews", permission: "delivery" },
