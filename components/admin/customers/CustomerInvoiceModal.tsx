...
export default function CustomerInvoiceModal({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 animate-in fade-in overflow-y-auto">
      <div className="bg-white border border-border rounded-3xl max-w-2xl w-full p-6 sm:p-8 shadow-2xl space-y-6 my-8">
        {/* Invoice Header */}
        <div className="flex items-center justify-between border-b border-border pb-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-primary text-white flex items-center justify-center font-black text-xl">
              F
            </div>
            <div>
        ...
        <div className="grid grid-cols-2 gap-4 text-xs">
          <div className="bg-gray-50 rounded-2xl p-4 border border-border space-y-1">
          ...
          <div className="bg-gray-50 rounded-2xl p-4 border border-border space-y-1 text-right">
        ...
        <div className="border border-border rounded-2xl overflow-hidden">
          <table className="w-full text-left border-collapse text-xs">
            <thead>
              <tr className="bg-gray-50 text-gray-500 font-bold border-b border-border">
        ...
        <div className="bg-gray-50 rounded-2xl p-4 border border-border space-y-2 text-xs">
        ...
        <div className="flex items-center justify-between pt-2">
          ...
          <Button onClick={onClose} variant="primary" size="sm" className="px-5 py-2.5 text-xs">
            Close Invoice
          </Button>
        </div>
      </div>
