  ...
  return (
    <div className="bg-section rounded-3xl p-6 md:p-8 border border-border relative overflow-hidden h-full flex flex-col justify-between">
      ...
      <div>
        ...
        <h3 className="text-2xl font-bold text-foreground mb-2 relative z-10">Live Chat Support</h3>
        <p className="text-gray-text text-sm mb-6 relative z-10 leading-relaxed">
          Get instant help from our support agents for urgent issues regarding active orders.
        </p>

        <div className="flex items-center gap-3 bg-white p-4 rounded-2xl border border-border mb-8 relative z-10">
          <Zap className="w-5 h-5 text-yellow-500" />
          <div>
            <p className="text-[#9CA3AF] text-xs font-bold uppercase tracking-widest mb-0.5">Avg Response Time</p>
            <p className="text-foreground font-black">Under 2 Minutes</p>
          </div>
        </div>
      </div>
