...
export default function SupportHeader({ query = "", onQueryChange, onSearch }: Props) {
  return (
    <div className="mb-16 text-center">
      ...
      <div className="max-w-3xl mx-auto relative group">
        ...
        <button
          type="button"
          onClick={() => onSearch?.()}
          className="absolute inset-y-2 right-2 rounded-full bg-primary px-8 font-bold text-white shadow-[0_8px_18px_rgba(226, 55, 68,0.18)] transition-all hover:bg-primary"
        >
          Search
        </button>
      </div>
