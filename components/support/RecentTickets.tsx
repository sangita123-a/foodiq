  ...
  return (
    <div className="bg-[#F8FAFC] rounded-3xl p-6 md:p-8 border border-[#E5E7EB] h-full">
      <div className="flex items-center justify-between mb-8">
        <h2 className="text-2xl font-bold text-[#111827]">Recent Requests</h2>
        <Ticket className="w-6 h-6 text-[#9CA3AF]" />
      </div>

      <div className="space-y-4">
        {tickets.map((ticket) => (
          <div key={ticket.id} className="bg-white border border-[#E5E7EB] hover:border-[#E5E7EB] transition-colors rounded-2xl p-5 flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4 self-start md:self-center">
              ...
              <button className="w-10 h-10 rounded-xl bg-[#F8FAFC] hover:bg-[#F8FAFC] flex items-center justify-center transition-colors text-[#6B7280] hover:text-[#111827] group">
