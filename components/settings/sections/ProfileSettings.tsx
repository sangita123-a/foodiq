  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row items-start gap-6 mb-10">
        ...
        />
        <div className="pt-2">
          <h3 className="text-foreground font-bold text-lg">Your photo</h3>
      ...
      <form id="settings-form" onSubmit={handleSave} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <label className="block text-sm font-bold text-gray-text mb-2">Email Address</label>
            <input
              type="email"
              name="email"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <label className="block text-sm font-bold text-gray-text mb-2">Date of Birth</label>
            <input
              type="date"
              name="dob"
              defaultValue={dob}
        ...
        <div>
          <label className="block text-sm font-bold text-gray-text mb-2">Gender</label>
          <select
            name="gender"
