    ...
    <div className="bg-[#F8FAFC] rounded-2xl p-6 border border-[#E5E7EB] mb-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <Link
          ...
          className="text-primary font-bold text-sm hover:text-[#111827] transition-colors flex items-center gap-1"
        >
      ...
      {addresses.length === 0 ? (
        <div className="rounded-xl border border-dashed border-[#E5E7EB] p-8 text-center text-[#6B7280]">
          ...
          {addresses.map((addr) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-sm text-[#6B7280] mb-1">{addr.address}</p>
                <p className="text-xs text-[#9CA3AF]">{addr.details}</p>

                <div className="mt-4 flex gap-3 text-xs font-bold text-[#6B7280]">
                  <button
                    type="button"
                    onClick={(event) => {
