  ...
  return (
    <div className="bg-[#F8FAFC] rounded-2xl p-6 border border-[#E5E7EB] mb-6">
      ...
      <div className="flex flex-wrap gap-2 mb-4">
        {commonInstructions.map((inst, idx) => (
          <button 
            ...
            className="bg-[#F8FAFC] hover:bg-[#F8FAFC] text-[#6B7280] text-xs px-3 py-1.5 rounded-full border border-[#E5E7EB] transition-colors"
          >
            + {inst}
          </button>
        ))}
      ...
      <textarea 
        ...
        className="w-full bg-white text-[#111827] border border-[#E5E7EB] rounded-xl p-4 text-sm focus:outline-none focus:border-primary transition-colors min-h-[100px] resize-none placeholder-gray-600"
      ></textarea>
    </div>
  );
}
