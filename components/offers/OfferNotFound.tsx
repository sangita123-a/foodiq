      ...
      <div className="container mx-auto px-4 md:px-8 py-20 max-w-lg text-center">
        <div className="bg-section border border-border rounded-3xl p-10">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link
              href="/"
              className="inline-flex items-center justify-center text-gray-text hover:text-foreground px-6 py-3 rounded-xl border border-border font-medium transition-colors"
            >
              Back to Home
            </Link>
          </div>
