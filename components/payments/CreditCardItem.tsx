  ...
  return (
    <motion.div 
      ...
      className={`bg-[#171717] rounded-[24px] p-6 md:p-8 border hover:border-white/20 transition-all duration-300 relative flex flex-col h-full group shadow-lg ${
        card.isDefault ? "border-primary/50 shadow-[0_0_15px_rgba(255,45,59,0.1)]" : "border-white/5"
      }`}
    >
      
      {/* Physical Card Representation */}
      <div className="bg-gradient-to-br from-[#222] to-[#111] border border-white/10 rounded-2xl p-6 mb-8 relative overflow-hidden shadow-2xl">
        ...
        <div className="flex justify-between items-end relative z-10">
          <div>
            <div className="text-[10px] text-gray-400 uppercase tracking-widest mb-1">Card Holder</div>
      ...
      <div className="flex flex-wrap items-center gap-3 mt-auto">
        <button 
          onClick={() => onEdit(card)}
          className="flex-1 bg-white/5 hover:bg-white/10 text-white px-4 py-3 rounded-xl text-sm font-bold flex items-center justify-center gap-2 transition-colors border border-white/5"
        >
