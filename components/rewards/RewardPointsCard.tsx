...
export default function RewardPointsCard({ totalPoints, level, pointsToNextLevel, progressPercent, totalSavings, expiryDate, onRedeem }: Props) {
  ...
  return (
    <motion.div 
      ...
      className="bg-[#171717] rounded-3xl p-6 md:p-8 border border-white/5 shadow-2xl relative overflow-hidden mb-12"
    >
      {/* Background Decor */}
      ...
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-8 relative z-10">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="text-gray-400 font-bold uppercase tracking-widest text-sm">Total Reward Points</h3>
          </div>
          ...
          <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-to-r border shadow-lg mb-6 ${getLevelColor()}`}>
            ...
            <span className="font-bold text-white tracking-wide">{level} Member</span>
          </div>
          ...
          <div className="h-3 w-full bg-[#111] rounded-full overflow-hidden border border-white/5">
            <motion.div 
              initial={{ width: 0 }}
        ...
        <div className="flex-1 md:flex-none flex flex-col justify-between md:min-w-[250px] gap-6">
          ...
          <div className="bg-[#111] border border-white/5 rounded-2xl p-5">
            <div className="flex items-center justify-between mb-1">
              <span className="text-gray-400 text-sm font-bold">Total Savings</span>
          ...
          <div>
            <p className="text-gray-500 text-xs mb-3 text-center md:text-left">Points expire on {expiryDate}</p>
            <button 
              onClick={onRedeem}
