    ...
    <div className="py-24 px-4 md:px-8">
      <div className="container mx-auto">
        ...
        <motion.div 
          ...
          className="bg-gradient-to-br from-[#FF2D3B] to-[#b31420] rounded-[40px] p-12 md:p-20 text-center relative overflow-hidden shadow-[0_20px_60px_rgba(255,45,59,0.25)]"
        >
          {/* Background Decor */}
          <div className="absolute top-0 right-0 w-64 h-64 bg-white/10 rounded-full blur-[80px] pointer-events-none translate-x-1/2 -translate-y-1/2"></div>
