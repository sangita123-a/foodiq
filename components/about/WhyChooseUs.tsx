        ...
        >
          {features.map((feature, idx) => (
            <motion.div 
              ...
              className="bg-[#171717] rounded-3xl p-6 md:p-8 flex flex-col items-center justify-center text-center border border-white/5 hover:border-primary/50 transition-colors group shadow-lg"
            >
