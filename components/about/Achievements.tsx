...
export default function Achievements() {
  return (
    <div className="py-24 bg-gradient-to-br from-primary to-primary-hover text-white">
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-4 text-center">
          ...
          <div>
            ...
            <p className="text-foreground/80 font-bold uppercase tracking-widest text-sm">Happy Customers</p>
          </div>
          ...
          <div>
            ...
            <p className="text-foreground/80 font-bold uppercase tracking-widest text-sm">Partner Restaurants</p>
          </div>
          ...
          <div>
            ...
            <p className="text-foreground/80 font-bold uppercase tracking-widest text-sm">Orders Delivered</p>
          </div>
          ...
          <div>
            ...
            <p className="text-foreground/80 font-bold uppercase tracking-widest text-sm">Customer Rating</p>
          </div>
