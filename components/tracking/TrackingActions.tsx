  ...
  return (
    <div className="bg-section rounded-3xl p-6 md:p-8 border border-border mb-8">
      ...
      <div className="flex flex-col gap-3">
        <button
          type="button"
          className="w-full bg-white hover:bg-section text-foreground py-4 rounded-xl font-bold flex items-center justify-between px-6 transition-colors border border-border"
        >
          <div className="flex items-center gap-3">
            <Store className="w-5 h-5 text-gray-text" />
            Contact Restaurant
          </div>
        </button>
