...
const PIZZA_DISHES = buildDishes(
  ...
  [
    ...
    { name: "Classic Thin Crust", image: "/images/catalog/dishes/pizza/classic-margherita.webp", price: 229, isVeg: true, restaurantName: "Pizza Italia Oven" },
    { name: "Supreme Feast Pizza", image: "/images/catalog/dishes/pizza/veggie-supreme-pizza.webp", price: 499, isVeg: false, restaurantName: "Pizza Hut" },
  ],
...
const BURGER_DISHES = buildDishes(
  ...
  [
    ...
    { name: "Classic Flame Burger", image: "/images/catalog/dishes/burger/cheese-burger.webp", price: 189, isVeg: false, restaurantName: "McDonald's" },
    { name: "Tower Zinger Burger", image: "/images/catalog/dishes/burger/crispy-chicken-burger.webp", price: 279, isVeg: false, restaurantName: "KFC" },
...
const BIRYANI_DISHES = buildDishes(
  ...
  [
    ...
    { name: "Royal Biryani Platter", image: "/images/catalog/dishes/biryani/family-biryani-feast.webp", price: 799, isVeg: false, restaurantName: "Biryani By Kilo" },
...
const MOMOS_DISHES = buildDishes(
  ...
  [
    ...
    { name: "Schezwan Momos", image: "/images/catalog/dishes/chinese/chicken-momos.webp", price: 159, isVeg: true },
    { name: "Cheese Corn Momos", image: "/images/catalog/dishes/chinese/veg-momos.webp", price: 179, isVeg: true },
    { name: "Afghan Cream Momos", image: "/images/catalog/dishes/dish-mo-1.jpg", price: 199, isVeg: true },
    { name: "Pan Fried Momos", image: "/images/catalog/dishes/dish-mo-2.jpg", price: 159, isVeg: true },
    { name: "Jhol Momos Bowl", image: "/images/catalog/dishes/chinese/dim-sum.webp", price: 169, isVeg: false },
    { name: "Mushroom Momos", image: "/images/catalog/dishes/chinese/veg-momos.webp", price: 139, isVeg: true },
    { name: "Wheat Veg Momos", image: "/images/catalog/dishes/chinese/veg-momos.webp", price: 129, isVeg: true },
    { name: "Dragon Chicken Momos", image: "/images/catalog/dishes/chinese/chicken-momos.webp", price: 179, isVeg: false },
    { name: "BBQ Grilled Momos", image: "/images/catalog/dishes/dish-mo-2.jpg", price: 189, isVeg: false },
    { name: "Soya Crunch Momos", image: "/images/catalog/dishes/dish-mo-1.jpg", price: 139, isVeg: true },
...
const COFFEE_DISHES = buildDishes(
  ...
  [
    ...
    { name: "Iced Latte", image: "/images/catalog/dishes/beverages/cold-coffee.webp", price: 149, isVeg: true },
    { name: "Hazelnut Latte", image: "/images/catalog/dishes/beverages/cafe-latte.webp", price: 159, isVeg: true },
    { name: "Flat White", image: "/images/catalog/dishes/beverages/classic-cappuccino.webp", price: 149, isVeg: true },
    { name: "Cortado", image: "/images/catalog/dishes/beverages/espresso-coffee.webp", price: 129, isVeg: true },
    ...
    { name: "Caramel Macchiato", image: "/images/catalog/dishes/beverages/salted-caramel-frappe.webp", price: 169, isVeg: true },
    { name: "Double Espresso", image: "/images/catalog/dishes/beverages/espresso-coffee.webp", price: 109, isVeg: true },
    { name: "Affogato", image: "/images/catalog/dishes/desserts/tiramisu-cup.webp", price: 199, isVeg: true },
    { name: "Cold Brew", image: "/images/catalog/dishes/beverages/cold-coffee.webp", price: 139, isVeg: true },
    { name: "Turkish Coffee", image: "/images/catalog/dishes/beverages/espresso-coffee.webp", price: 129, isVeg: true },
...
const FRIES_DISHES = buildDishes(
  ...
  [
    ...
    { name: "Masala Fries", image: "/images/catalog/dishes/fast-food/peri-peri-fries.webp", price: 119, isVeg: true },
    { name: "Garlic Aioli Fries", image: "/images/catalog/dishes/fast-food/cheese-fries.webp", price: 139, isVeg: true },
    { name: "Truffle Fries", image: "/images/catalog/dishes/burger/french-fries.webp", price: 169, isVeg: true },
    { name: "BBQ Fries", image: "/images/catalog/dishes/fast-food/peri-peri-fries.webp", price: 149, isVeg: true },
    { name: "Sour Cream Fries", image: "/images/catalog/dishes/fast-food/cheese-fries.webp", price: 129, isVeg: true },
    { name: "Chili Cheese Fries", image: "/images/catalog/dishes/fast-food/cheese-fries.webp", price: 159, isVeg: true },
    { name: "Curly Fries", image: "/images/catalog/dishes/burger/french-fries.webp", price: 139, isVeg: true },
    { name: "Sweet Potato Fries", image: "/images/catalog/dishes/fast-food/peri-peri-fries.webp", price: 149, isVeg: true },
    { name: "Waffle Fries", image: "/images/catalog/dishes/burger/french-fries.webp", price: 129, isVeg: true },
    { name: "Crinkle Cut Fries", image: "/images/catalog/dishes/fast-food/cheese-fries.webp", price: 109, isVeg: true },
...
const WRAPS_DISHES = buildDishes(
  ...
  [
    ...
    { name: "Falafel Wrap", image: "/images/catalog/dishes/fast-food/paneer-wrap.webp", price: 149, isVeg: true },
    { name: "Kebab Wrap", image: "/images/catalog/dishes/street-food/chicken-kathi-roll.webp", price: 209, isVeg: false },
    { name: "Egg Roll Wrap", image: "/images/catalog/dishes/street-food/chicken-kathi-roll.webp", price: 129, isVeg: false },
    { name: "Cheese Burst Wrap", image: "/images/catalog/dishes/fast-food/chicken-wrap.webp", price: 159, isVeg: true },
    { name: "BBQ Chicken Wrap", image: "/images/catalog/dishes/fast-food/chicken-wrap.webp", price: 199, isVeg: false },
    { name: "Peri Peri Wrap", image: "/images/catalog/dishes/fast-food/chicken-wrap.webp", price: 189, isVeg: false },
    { name: "Hummus Veg Wrap", image: "/images/catalog/dishes/fast-food/paneer-wrap.webp", price: 149, isVeg: true },
    { name: "Grilled Paneer Wrap", image: "/images/catalog/dishes/fast-food/paneer-wrap.webp", price: 169, isVeg: true },
    { name: "Spicy Bean Wrap", image: "/images/catalog/dishes/fast-food/veggie-sub.webp", price: 139, isVeg: true },
    { name: "Classic Roll Wrap", image: "/images/catalog/dishes/street-food/paneer-kathi-roll.webp", price: 119, isVeg: true },
    { name: "Double Chicken Wrap", image: "/images/catalog/dishes/fast-food/chicken-wrap.webp", price: 219, isVeg: false },
    { name: "Supreme Loaded Wrap", image: "/images/catalog/dishes/street-food/chicken-kathi-roll.webp", price: 199, isVeg: false },
  ],
...
const NOODLES_DISHES = buildDishes(
  ...
  [
    ...
    { name: "Veg Noodles", image: "/images/catalog/dishes/chinese/hakka-noodles.webp", price: 159, isVeg: true },
    { name: "Chow Mein", image: "/images/catalog/dishes/chinese/chow-mein.webp", price: 169, isVeg: true },
    { name: "Chicken Fried Noodles", image: "/images/catalog/dishes/chinese/schezwan-noodles.webp", price: 229, isVeg: false },
    { name: "Garlic Noodles", image: "/images/catalog/dishes/chinese/hakka-noodles.webp", price: 179, isVeg: true },
    { name: "Singapore Noodles", image: "/images/catalog/dishes/chinese/schezwan-noodles.webp", price: 199, isVeg: true },
    { name: "Thai Basil Noodles", image: "/images/catalog/dishes/chinese/chow-mein.webp", price: 209, isVeg: true },
    { name: "Manchurian Noodles", image: "/images/catalog/dishes/chinese/schezwan-noodles.webp", price: 189, isVeg: true },
    { name: "Egg Noodles", image: "/images/catalog/dishes/chinese/hakka-noodles.webp", price: 169, isVeg: false },
    { name: "Paneer Noodles", image: "/images/catalog/dishes/chinese/chow-mein.webp", price: 199, isVeg: true },
    ...
    { name: "Szechuan Chicken Noodles", image: "/images/catalog/dishes/chinese/schezwan-noodles.webp", price: 249, isVeg: false },
    { name: "Kung Pao Noodles", image: "/images/catalog/dishes/chinese/chow-mein.webp", price: 229, isVeg: false },
    { name: "Veg Schezwan Noodles", image: "/images/catalog/dishes/chinese/schezwan-noodles.webp", price: 179, isVeg: true },
    { name: "Smoky BBQ Noodles", image: "/images/catalog/dishes/chinese/hakka-noodles.webp", price: 219, isVeg: false },
    { name: "Classic Wok Noodles", image: "/images/catalog/dishes/chinese/hakka-noodles.webp", price: 169, isVeg: true },
...
const DONUTS_DISHES = buildDishes(
  ...
  [
    ...
    { name: "Classic Sweet Donut", image: "/images/catalog/dishes/desserts/glazed-donuts.webp", price: 69, isVeg: true },
    { name: "Premium Frosted Donut", image: "/images/catalog/dishes/desserts/chocolate-cake.webp", price: 89, isVeg: true },
...
const ICECREAM_DISHES = buildDishes(
  ...
  [
    ...
    { name: "Mango Ice Cream", image: "/images/catalog/dishes/desserts/strawberry-ice-cream.webp", price: 89, isVeg: true },
    { name: "Kulfi Stick", image: "/images/catalog/dishes/desserts/vanilla-ice-cream.webp", price: 99, isVeg: true, restaurantName: "Haldiram's" },
    { name: "Cone Ice Cream", image: "/images/catalog/dishes/desserts/chocolate-ice-cream.webp", price: 119, isVeg: true },
    { name: "Cookie Dough Ice Cream", image: "/images/catalog/dishes/desserts/butterscotch-ice-cream.webp", price: 129, isVeg: true },
    { name: "Pistachio Ice Cream", image: "/images/catalog/dishes/desserts/vanilla-ice-cream.webp", price: 119, isVeg: true },
    { name: "Rocky Road Ice Cream", image: "/images/catalog/dishes/desserts/chocolate-ice-cream.webp", price: 129, isVeg: true },
    { name: "Mint Chip Ice Cream", image: "/images/catalog/dishes/desserts/strawberry-ice-cream.webp", price: 109, isVeg: true },
    { name: "Coffee Ice Cream", image: "/images/catalog/dishes/desserts/butterscotch-ice-cream.webp", price: 99, isVeg: true },
    { name: "Fruit Overload Ice Cream", image: "/images/catalog/dishes/desserts/strawberry-ice-cream.webp", price: 119, isVeg: true },
    { name: "Triple Scoop Sundae", image: "/images/catalog/dishes/desserts/hot-chocolate-sundae.webp", price: 179, isVeg: true },
    { name: "Family Ice Cream Tub", image: "/images/catalog/dishes/desserts/vanilla-ice-cream.webp", price: 299, isVeg: true },
    { name: "Belgian Waffle Ice Cream", image: "/images/catalog/dishes/desserts/belgian-waffle.webp", price: 189, isVeg: true },
  ],
